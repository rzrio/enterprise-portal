...
<ol>
    ...
    <li><p>A normal version number MUST take the form X.Y.Z where X, Y, and Z are
            ...
            Each element MUST increase numerically. For instance: 1.9.0 -> 1.10.0 -> 1.11.0.</p></li>
    ...
    <li><p>A pre-release version MAY be denoted by appending a hyphen and a
            ...
            1.0.0-x.7.z.92.</p></li>
    <li><p>Build metadata MAY be denoted by appending a plus sign and a series of dot
    ...
    <li><p>Precedence refers to how versions are compared to each other when ordered.
